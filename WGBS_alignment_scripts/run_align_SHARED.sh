...
qsub -l mem_free=16G,h_vmem=18G,h_fsize=200G -pe local 8 -hold_jid bismarkmerge_${samp} -cwd -N bismarkextract_${samp} -cwd /amber3/feinbergLab/personal/sramazan/bash/scripts/gtex/methyl_extract.sh ${samp} ${OUTPUT_DIR} ${TMP_DIR}
