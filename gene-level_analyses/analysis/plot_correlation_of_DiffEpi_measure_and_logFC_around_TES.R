# Plot correlation of DiffEpi measure with gene expression logFC around TES of
# genes
# Peter Hickey
# 2018-03-08
...
save_plot(
  "../figures/cor_DiffEpi_and_logFC_around_TES.faceted_with_CI.pdf",
  g,
  base_height = 10)

g <- ggplot(sx, aes(x = distance, y = abs(estimate), col = DiffEpi)) +
  ...
  scale_colour_manual(values = cols)
save_plot(
  "../figures/absolute_cor_DiffEpi_and_logFC_around_TES.overlaid_without_CI.pdf",
  g,
  base_height = 10)
